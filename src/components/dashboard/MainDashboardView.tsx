      ...
      <section>
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          {restaurants.slice(0, 6).map((restaurant, i) => (
            <div key={restaurant.id} className={`group relative flex flex-col overflow-hidden rounded-2xl border border-white/[0.06] bg-surface shadow-lg shadow-black/15 transition-all duration-500 hover:-translate-y-2 hover:border-emerald/30 hover:shadow-2xl hover:shadow-emerald/20 animate-fade-in stagger-${i + 1}`}>
              ...
              <div className="flex flex-1 flex-col gap-3 p-5">
                ...
                <Button type="button" variant="primary" className="mt-auto w-full rounded-xl transition-all duration-300 hover:scale-[1.02]" onClick={() => { setSelectedRestaurant(restaurant); router.push("/dashboard/order-food"); }}>
                  View Menu & Order
                </Button>
              </div>
            </div>
